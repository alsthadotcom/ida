...
export const DigitalSolutions: React.FC = () => {
    return (
            ...
            <div className="relative group">
                ...
                <div className="relative p-8 md:p-12 bg-zinc-900 ring-1 ring-zinc-800 rounded-lg leading-none flex flex-col items-center text-center max-w-md">
                    <div className="mb-6 p-4 bg-zinc-800/50 rounded-full">
                        <CpuChipIcon className="w-12 h-12 text-green-400" />
                    </div>
                    <h2 className="text-3xl font-bold text-white mb-4">Digital Solutions</h2>
                    <p className="text-zinc-400 mb-8 leading-relaxed">
                        Our premium suite of AI-driven business automation tools is currently in closed beta. 
                    </p>
